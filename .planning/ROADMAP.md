...
**Plans:** 2 plans
Plans:
- [ ] 02-01-PLAN.md — TDD: NameResolver with cache/exact/normalized stages + ResolveResult dataclass + persistent JSON cache
- [ ] 02-02-PLAN.md — TDD: Fuzzy matching stage + unresolved contract verification

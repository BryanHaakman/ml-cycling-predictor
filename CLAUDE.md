...
- **Bet sizing:** quarter Kelly, max 2% bankroll per bet. Confidence scaling applied: low-confidence bets get reduced stakes proportionally (`scale = clamp((prob − 0.5) / 0.2, 0.5, 1.0)`)
